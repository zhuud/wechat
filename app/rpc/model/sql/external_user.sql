...
DROP TABLE IF EXISTS tb_external_user_attribute;
...
DROP TABLE IF EXISTS tb_external_user_follow;
CREATE TABLE `tb_external_user_follow` (
  ...
  `status` tinyint(3) unsigned NOT NULL DEFAULT 1 COMMENT '状态 (0:删除 / 1:正常) | 2020-09-10',
  `status_source` varchar(50) NOT NULL DEFAULT "" COMMENT '状态变更来源 | 2020-09-10',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间 | 2020-09-10',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间 | 2020-09-10',
...
DROP TABLE IF EXISTS tb_external_user_follow_attribute;
...
DROP TABLE IF EXISTS tb_external_user_tag;
CREATE TABLE `tb_external_user_tag` (
  ...
  `weight` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '排序的次序值，order值大的排序靠前 微信为order关键字 | 2020-09-10',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态 (0:删除 / 1:正常) | 2020-09-10',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间 | 2020-09-10',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间 | 2020-09-10',
  PRIMARY KEY (`tag_id`),
...
CREATE TABLE `tb_operation_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键 | 柴利瑶 | 2020-05-15',
